...
export class Db {
	constructor(dbName, storeName) {
				...
				AssertNotNull(dbName, "argument dbName in " + this.constructor.name + ".js should not be null")
			
				AssertNotNull(storeName, "argument storeName in " + this.constructor.name + ".js should not be null")
